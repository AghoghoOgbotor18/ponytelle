            ...
            <div className="relative z-10">
                ...
                <div className="flex gap-2">
                    <div className="relative w-full">
                        ...
                        <input type="email" placeholder="Enter your email" className="w-full pl-10 pr-4 py-3 rounded-full bg-white/10 border border-white/20 placeholder:text-white/50 text-white focus:outline-none focus:ring-2 focus:ring-white/40" />
                    </div>
                    <button className="shrink-0 bg-white text-black px-6 py-3 rounded-full font-medium hover:bg-zinc-200 transition">
                        Join
                    </button>
                </div>
